...
import "../Styles/ComponentsStyles/Testimonial.css"; // Import CSS file
...
const Testimonial = () => {
  return (
    <section className="ezy__testimonial1 light text-center">
      <Container>
        <Row className="justify-content-center mb-md-4" style={{textAlign:'center !important'}}>
          <Col lg={{ span: 6, offset: 3 }} xl={{ span: 6, offset: 3 }}> {/* Adjusted column size and offset */}
          <div>
            <h2 className="ezy__testimonial1-heading mb-3">
              Client Reviews
            </h2>
            <p className="ezy__testimonial1-sub-heading mb-0">
              It’s easier to reach your problem's solution when you have the right
              counsellor. Take a look and find the right one for you!
            </p>
          </div>
